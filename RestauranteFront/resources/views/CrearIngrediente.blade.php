  ...
  <div class="main-container">
    <nav>
      ...
      <div class="submenu">
        ...
        <a href="#" style="color: #5E7F5E;"><i class="fa-solid fa-bowl-food" style="margin-left: 18px; padding-right: 10px;"></i>Crear Platillo</a>
      </div>
        ...
        <div style="width: 100%; max-width: 1400px; margin: 0 auto; background-color: #a4a9a8; color: black; font-weight: bold;" >
            ...
            <form action="{{ route('crearPlatillo') }}" method="POST" style="width: 100%; max-width: 1400px; margin: 0 auto;" >
                ...
                <div class="mb-3" style="margin-left: 15px; margin-right: 15px;">
                    <label for="">Agregar Nuevo Ingrediente</label>
                    <input type="text" name="nombreIngrediente" class="form-control" style="background-color: #ffffff8f;">
                </div>
                <div class="mb-3" style="margin-left: 15px; margin-right: 15px;">
                    <label for="">Descripcion Nuevo Ingrediente</label>
                    <input type="text" name="descripcionUnidad" class="form-control" style="background-color: #ffffff8f;">
                </div>
                <div class="mb-3" style="margin-left: 15px; margin-right: 15px;">
                    <label for="">Cantidad de Ingrediente Comprada</label>
                    <input type="text" name="cantidadAlmacen" class="form-control" style="background-color: #ffffff8f;">
                </div>
                <div class="mb-3" style="margin-left: 15px; margin-right: 15px;">
                    <label for="">Proveedor de Ingrediente ID</label>
                    <input type="text" name="proveedor" class="form-control" style="background-color: #ffffff8f;">
                </div>
                <div class="mb-3" style="margin-left: 15px; margin-right: 15px;">
                    <label for="">Cantidad minima de Ingrediente que se desea tener</label>
                    <input type="text" name="stockMinimo" class="form-control" style="background-color: #ffffff8f;">
                </div>
