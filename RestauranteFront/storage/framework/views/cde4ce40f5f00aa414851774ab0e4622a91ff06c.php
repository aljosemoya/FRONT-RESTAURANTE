    ...
    <?php if(isset($platillos) && count($platillos) > 0): ?>
        ...
        <div class="plato-carta">
            <div class="img-plato-carta">
              <img src="<?php echo e($platillo['platillo']['url']); ?>" alt="">
            </div>
            <div class="title-plato-carta">
              <h4><?php echo e($platillo['platillo']['nombreProducto']); ?></h4>
              <p>
                ...
                <span><?php echo e($ingrediente['nombreIngrediente']); ?> (<?php echo e($ingrediente['cantidadUtilizada']); ?>), </span>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </p>
            </div>
            <div class="precio-plato-carta">
              <span><?php echo e($platillo['platillo']['precio']); ?></span>
            </div>
            <div class="agregar-plato-carta">
             <button type="submit" class="btn btn-success"  onclick="agregarAlCarrito('<?php echo e($platillo['platillo']['productoID']); ?>')">Agregar</button>
            </div>
          </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>   
    <?php endif; ?>    
    </div>>
    <form id="carrito-form" action="<?php echo e(route('generarOrden')); ?>" method="post" style="display: none;">
     <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\Users\Jose Moya\Documents\Lenguajes de Programación\Proyecto\RestaurantanteFront\RestauranteFront\resources\views/verPlatillosMenu.blade.php ENDPATH**/ ?>