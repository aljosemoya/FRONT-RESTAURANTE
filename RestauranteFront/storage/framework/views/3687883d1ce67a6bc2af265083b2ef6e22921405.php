  ...
  <div class="main-container">
    ...
    <section style="display: flex; justify-content: center; align-items: center; ">
        <div style="width: 100%; max-width: 1400px; margin: 0 auto; background-color: #a4a9a8; color: black; font-weight: bold;" >
            ...
            <form action="<?php echo e(route('crearPlatillo')); ?>" method="POST" style="width: 100%; max-width: 1400px; margin: 0 auto;" >
                <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\Users\Jose Moya\Documents\Lenguajes de Programación\Proyecto\RestaurantanteFront\RestauranteFront\resources\views/crearPlatillo.blade.php ENDPATH**/ ?>