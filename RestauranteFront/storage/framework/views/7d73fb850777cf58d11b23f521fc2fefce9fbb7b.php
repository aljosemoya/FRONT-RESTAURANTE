...
<body>
  ...
  <div class="main-container">
    <nav>
      <a href="<?php echo e(route('administrarRestaurante')); ?>" id="platillos-link"><i class="fa-solid fa-folder-open"></i> Platillos</a>
      <div class="submenu">
        <a href="<?php echo e(route('verPlatillos')); ?>"><i class="fa-solid fa-list" style="margin-left: 18px; padding-right: 10px;"></i>Ver Platillos</a>
        <a href="#" style="color: #5E7F5E;"><i class="fa-solid fa-trash" style="margin-left: 18px; padding-right: 10px;"></i>Eliminar Platillos</a>
        <a href="<?php echo e(route('EditorNuevoPlatillo')); ?>"><i class="fa-solid fa-bowl-food" style="margin-left: 18px; padding-right: 10px;"></i>Crear Platillo</a>
      </div>
    ...
    <section>
      <table class="table">
        ...
        <thead>
          ...
          <th scope="col" style="background-color: #A4A9A8;">Eliminar Platillo</th>
        </thead>
        <tbody>
        <?php if(isset($platillos) && count($platillos) > 0): ?>
                <?php $__currentLoopData = $platillos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $platillo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td style="background-color: #A4A9A8;"><?php echo e($platillo['platillo']['productoID']); ?></td>
                        <td style="background-color: #A4A9A8;"><?php echo e($platillo['platillo']['nombreProducto']); ?></td>
                        <td style="background-color: #A4A9A8;"><?php echo e($platillo['platillo']['precio']); ?></td>
                        <td style="background-color: #A4A9A8;">
                            <ul class="list-group">
                                <?php $__currentLoopData = $platillo['ingredientes']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ingrediente): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li style="background-color: #A4A9A8;" class="list-group-item">
                                        <?php echo e($ingrediente['nombreIngrediente']); ?> (<?php echo e($ingrediente['cantidadUtilizada']); ?>)
                                    </li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </ul>
                        </td>
                        <td style="background-color: #A4A9A8;">
                        <form action="<?php echo e(route('eliminarPlatillo', ['id' => $platillo['platillo']['productoID']])); ?>" method="post" style="display: inline;">
                          <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\Users\Jose Moya\Documents\Lenguajes de Programación\Proyecto\RestaurantanteFront\RestauranteFront\resources\views/eliminarPlatillos.blade.php ENDPATH**/ ?>